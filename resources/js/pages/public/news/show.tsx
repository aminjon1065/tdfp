...
export default function NewsShow({
    ...
    const imageUrl =
        news.featured_image && currentUrl
        ...
        },
        {
            ...
            itemListElement: [
                ...
                },
                {
                    ...
                    item: currentUrl
                        ? new URL('/news', currentUrl).toString()
                        : undefined,
                },
                {
                    '@type': 'ListItem',
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid gap-8 lg:grid-cols-3">
                    <article className="lg:col-span-2">
                        ...
                        {translation.summary && (
                            <p className="mb-6 border-l-4 border-blue-700 pl-4 text-lg font-medium text-gray-600">
                                {translation.summary}
                            </p>
                        )}
                        <div
