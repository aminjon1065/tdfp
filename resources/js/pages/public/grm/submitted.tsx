...
export default function GrmSubmitted({
    ticket,
    trackingToken,
}: {
    ticket: string;
        ...
        >
            ...
            <div className="container mx-auto max-w-lg px-4 py-20 text-center">
                ...
                <p
                    ...
                    aria-live="polite"
                >
                    {t(locale, 'grm.submittedEmailNotice')}
                </p>
                <section
                ...
                >
                    ...
                    <dl className="space-y-4">
                        <div>
                            <dt className="text-sm text-gray-500">
                                {t(locale, 'grm.ticketNumberLabel')}
                            </dt>
                        ...
                        <div>
                            <dt className="text-sm text-gray-500">
                                {t(locale, 'grm.trackingTokenLabel')}
                            </dt>
                            <dd className="mt-1 flex flex-wrap items-center justify-center gap-1">
                                <span className="font-mono text-xl font-bold break-all text-slate-800">
                                    {trackingToken}
                                </span>
                                <CopyButton
                                    value={trackingToken}
                    ...
                    <p className="mt-1 text-xs text-gray-400">
                        {t(locale, 'grm.trackingSaveNotice')}
                    </p>
                </section>
                <div className="flex justify-center gap-3">
                    <Button asChild>
                        <Link href={publicHref('/grm/track')}>
                            {t(locale, 'grm.trackStatusAction')}
                        </Link>
                    </Button>
