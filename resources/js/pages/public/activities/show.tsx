...
export default function ActivityShow({ activity }: { activity: any }) {
    ...
    const imageUrl =
        activity.featured_image && currentUrl
            ? new URL(
                  `/storage/${activity.featured_image}`,
                  currentUrl,
              ).toString()
            : undefined;
        ...
        },
        {
            ...
            itemListElement: [
                ...
                },
                {
                    ...
                    item: currentUrl
                        ? new URL('/activities', currentUrl).toString()
                        : undefined,
                },
                {
                    '@type': 'ListItem',
    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto max-w-4xl px-4 py-12">
                <Link
                    href={publicHref('/activities')}
                    className="mb-6 inline-flex items-center gap-1.5 text-sm text-[var(--public-accent)] hover:underline"
                >
                ...
                <Badge
                    ...
                    className="mt-4 mb-4 block w-fit"
                >
                ...
                {(activity.start_date || activity.end_date) && (
                    <div className="mb-6 flex items-center gap-2 text-sm text-gray-500">
                        ...
                        {formatLocalizedDate(activity.start_date, locale)}
                        {activity.end_date
                            ? ` – ${formatLocalizedDate(activity.end_date, locale)}`
                            : ''}
                    </div>
                )}
                ...
                {translation.objectives && (
                    <div className="mb-6 rounded-lg bg-blue-50 p-4">
                        <h2 className="mb-2 font-semibold text-blue-900">
                            {t(locale, 'common.objectives')}
                        </h2>
                        <div
                            className="prose text-sm text-blue-800"
                            dangerouslySetInnerHTML={{
                                __html: translation.objectives,
                            }}
                        />
                    </div>
                )}
