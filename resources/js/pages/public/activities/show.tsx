...
export default function ActivityShow({ activity }: { activity: any }) {
    ...
    return (
        <PublicLayout title={translation.title ?? t(locale, 'activities.title')}>
            <div className="container mx-auto px-4 py-12 max-w-4xl">
                ...
                {activity.featured_image && (
                    <img src={`/storage/${activity.featured_image}`} alt={translation.title} className="mb-6 w-full rounded-lg object-cover max-h-80" />
                )}
