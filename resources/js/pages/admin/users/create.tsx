...
export default function AdminUsersCreate({ roles }: Props) {
    ...
    return (
        ...
        >
            <Head
                title={`${t(locale, 'admin.form.create')} ${t(locale, 'admin.content.users')}`}
            />
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="password_confirmation">
                            {t(locale, 'admin.form.confirmPassword')}
                        </Label>
                        <Input
                    ...
                    <div className="flex gap-3 pt-2">
                        <Button type="submit" disabled={processing}>
                            {processing
                                ? t(locale, 'admin.form.currentlyCreating')
                                : t(locale, 'admin.content.addUser')}
                        </Button>
                        <Button
                            type="button"
